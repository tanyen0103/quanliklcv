...
@section('content')
				...
				<div class="col-lg-8">
					<nav style="--falcon-breadcrumb-divider:'»';" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Kê khai hoạt động khác</li>
						</ol>
					</nav>
				</div>
			</div>
	...
	<div class="card mb-0">
		<div class="card-header bg-light">
			<h5 class="mb-0">Kê khai hoạt động khác</h5>
		</div>
				...
				<table id="DataList" class="table table-bordered table-hover table-sm overflow-hidden">
					<thead>
						<tr>
							...
							<th class="text-nowrap" width="30%">Hồ sơ</th>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="myModalLabel">Thêm kê khai hoạt động khác</h5>
